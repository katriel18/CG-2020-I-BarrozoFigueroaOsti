...
void init (GLFWwindow* window) {
	...
	m_Vertices = new GLfloat[90] { 			///////////////////katriel////////////////////////
	...
	glBufferData(
			...
			90 * sizeof(GLfloat),	// tamanho do buffer 					////////////////////katriel////////////////////////
...
void display(GLFWwindow* window, double currentTime) {
		...
		glClearColor(0.0f, 1.0f, 1.0f, 0.0f); ///////////////////katriel////////////////////////

		glClear( GL_COLOR_BUFFER_BIT);  ///////////////////katriel////////////////////////
	...
	glBindVertexArray(m_VAO);
    glDrawArrays(GL_TRIANGLES, 0, 15);					///////////////////katriel////////////////////////
	glBindVertexArray(0);
...
int main(void) {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 500, "Barrozo Figueroa Osti Katriel", NULL, NULL);
